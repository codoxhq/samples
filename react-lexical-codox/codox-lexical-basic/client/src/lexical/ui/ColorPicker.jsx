...
export default function ColorPicker({ color, onChange }) {
  ...
  useEffect(() => {
    ...
    if (innerDivRef.current !== null && onChange) {
      // TODO: [IVAN-DEV extract to own plugin] - disabled - instead call onChange only on user explicit actions
  ...
  let onColorClick = (basicColor) => {
    setInputColor(basicColor);
    let newSelfColor = transformColor('hex', basicColor);
    setSelfColor(newSelfColor);
    onChange(newSelfColor.hex, skipAddingToHistoryStack);
  };
      ...
      <div className="color-picker-basic-color">
        {basicColors.map((basicColor) => (
          <button
            ...
            onClick={() => onColorClick(basicColor)}
          />
        ))}
      </div>
      <MoveWrapper
