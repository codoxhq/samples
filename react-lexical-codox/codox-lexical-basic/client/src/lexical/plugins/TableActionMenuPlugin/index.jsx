...
function TableActionMenu({
  ...
  useEffect(() => {
    ...
    if (menuButtonElement != null && dropDownElement != null && rootElement != null) {
      ...
      // BUGFIX: origina code bug - incorrect dropdown position when doc is scrilled
      // dropDownElement.style.left = `${leftPosition + window.scrollX}px`;
      dropDownElement.style.left = `${menuButtonRect.right}px`;
      ...
      dropDownElement.style.top = `${menuButtonRect.bottom}px`;
    }
