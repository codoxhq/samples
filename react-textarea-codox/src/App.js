...
function App() {
  ...
  useEffect(() => {
    // create a new codox instance on mounting application
      ...
      <div id="app">
        <div className="header">
          ...
          >
            <img
              id="logo"
              src="https://www.codox.io/assets/img/wave.svg"
              alt=""
            />
          </a>
          <div className="logo-title">
            Create your own Google Docs with Wave + TextArea on React
          </div>
        </div>
