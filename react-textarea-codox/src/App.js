...
import RealTimeTextAreaEditor from './components/RealTimeTextAreaEditor'
import './App.css';
...
function App() {
  ...
  const [docs, updateDocs] = useState([
    { "id": "asfafa", name: "doc1", "content": "Hello World" },
    ...
    <div className="App">
      <div id="app">
        <div className="header">
          <a href="https://www.codox.io" rel="noreferrer" className="logo-link" target="_blank">
            <img id="logo" src="https://www.codox.io/assets/img/wave.svg" alt="" />
          </a>
          <div className="logo-title">Create your own Google Docs with Wave + TextArea on React</div>
        </div>
        ...
        <div className="main-container">
          ...
          <div className="editors">
            {activeDoc.id && <RealTimeTextAreaEditor
              username={username}
              apiKey={apiKey}
              codox={codox}
              docId={activeDoc.id}
