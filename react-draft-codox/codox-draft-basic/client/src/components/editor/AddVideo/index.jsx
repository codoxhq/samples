/**
 *
 * Module taken from official example
 * https://github.com/draft-js-plugins/draft-js-plugins/blob/master/packages/docs/components/Examples/video/CustomAddVideoVideoEditor/VideoAdd/index.js
 *
 */
